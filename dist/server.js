...
import { logger, configManager, initializeEnvironment, toolRegistry, isKnowledgeOSError, } from './core/index.js';
import { CanvasTools, canvasToolDefinitions, VaultTools, vaultToolDefinitions, DashboardTools, dashboardToolDefinitions, } from './tools/index.js';
// =============================================================================
// Server Setup
// =============================================================================
...
// Tool Registration
// =============================================================================
function registerCanvasTools(tools) {
...
function getCanvasToolHandler(name, tools) {
    const handlers = {
...
function registerVaultTools(tools) {
...
function getVaultToolHandler(name, tools) {
    const handlers = {
...
function registerDashboardTools(tools) {
...
function getDashboardToolHandler(name, tools) {
    const handlers = {
