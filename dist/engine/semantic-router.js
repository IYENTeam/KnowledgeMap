 ...
 */
import { RELATION_TO_ZONE, ZONE_SPECS, ZONE_LABELS, RELATION_ALIASES, } from '../types/index.js';
// =============================================================================
...
export class SemanticRouter {
     ...
     */
    static getEdgeDirections(relation) {
     ...
     */
    static getDefaultColor(relation) {
        const { spec } = this.route(relation);
     ...
     * Zone의 한글 라벨을 반환합니다.
     */
    static getZoneLabel(zone) {
        return ZONE_LABELS[zone] || '기타';
    }
    /**
     * 모든 지원되는 관계 목록을 반환합니다.
     */
    static getSupportedRelations() {
        return Object.keys(RELATION_TO_ZONE);
    }
    /**
     * 모든 Zone 목록을 반환합니다.
     */
    static getAllZones() {
        return Object.keys(ZONE_SPECS);
    }
    /**
     * Zone별 노드 크기를 반환합니다.
     */
    static getNodeSize(zone) {
